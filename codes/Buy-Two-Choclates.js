...
some non-negative leftover money. You would like to minimize the 
...
Output: 0
Explanation: Purchase the chocolates priced at 1 
and 2 units respectively. You will have 3 - 3 = 0 
...
const prices =  [1,2,2];
const money = 3;
const buying = buyChoco(prices,money)
console.log(buying);
