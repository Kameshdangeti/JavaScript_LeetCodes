...
//promise2 will both resolve with a number.The returned promise should resolve with the
...
Output: 7
Explanation: The two input promises resolve with 
the values of 2 and 5 respectively. The returned 
promise should resolve with a value of 2 + 5 = 7. 
The time the returned promise resolves is not 
